...
- `brief.json`     — [{id:"b01"…"b19", n, short_fa (≤ 28 chars, a noun phrase — the link label «شاخص N — short_fa» everywhere the item is referenced), text_fa (VERBATIM, do not edit), text_en, theme (kitchen|hosting|work|bath|rooms|caretaker|wellness|green|roof|storage|windows|facade|basement|ventilation|cost|stairs|lift), gloss_fa (1–2 sentences: what it really asks, in Arash's voice), in_attempt1_fa (how the 1399 design answered it, or "—"), in_attempt3_fa (how the 1403 design answered it, or "—"), status:"answered"|"partly"|"open"|"contradicted", related:{sheets:[], questions:[], concepts:[]}}]
- `questions.json` — [{id:"q-level-minus-2", title_fa, lead_fa, body_fa (2–4 paragraphs), owner_view_fa, architect_view_fa (neutral summary of what the architect argued, if anything), evidence_fa:[...] (concrete facts from sheets/reports), widget?: 'stacks'|'section-plus' (optional drawing hook), related:{brief:[], sheets:[], concepts:[], attempts:[]}}]
