...
- `brief.json`     — [{id:"b01"…"b19", n, text_fa (VERBATIM, do not edit), text_en, theme (kitchen|hosting|work|bath|rooms|house management|wellness|green|roof|storage|windows|facade|basement|ventilation|cost|stairs|lift), gloss_fa (1–2 sentences: what it really asks, in Arash's voice), in_attempt1_fa (how the 1399 design answered it, or "—"), in_attempt3_fa (how the 1403 design answered it, or "—"), status:"answered"|"partly"|"open"|"contradicted", related:{sheets:[], questions:[], concepts:[]}}]
...
- concepts: c-iwan, c-godal-baghcheh, c-shabak, c-hoz, c-nested-floors, c-bahamestan, c-double-skin, c-double-height-loft, c-student-unit, c-house management, c-roof-garden, c-tree, c-cross-ventilation, c-parking
...
kinds: living, kitchen, dining, bedroom, bath, study, storage, service, circulation, outdoor, void, parking, water, green, house management, hall.
